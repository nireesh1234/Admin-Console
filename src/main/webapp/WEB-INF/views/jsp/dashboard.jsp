...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="/ajaxspring/addService">Add Service</a></li>      
    </ul>
    <ul class="nav navbar-nav">
      <li><a href="/ajaxspring/applicationlogs">Applciation Logs</a></li>      
    </ul>
    <ul class="nav navbar-nav">
      <li><a href="/ajaxspring/old_dashboard">CAS3 Dashboard</a></li>      
    </ul>    
  </div>
</nav>
<body>
<div class="container">
  ...
  <br>
  <center><button type="button" class="btn btn-success">CASified Applications <span class="badge">${fileCount}</span></button></center>
			...
			<c:forEach var="user" items="${users}">
			    <tr>
			     <td>	
				    ...
				    <spring:url value="/${recordId}/update" var="updateUrl" />
                ...
                <td>
	                ...
	                <spring:url value="${user.id}" var="recordId" />  
	                <spring:url value="/${recordId}/delete" var="deleteUrl" />	
	                <a onclick="location.href='${deleteUrl}'"> <span class="glyphicon glyphicon-trash"></span></a>			
